...
```text
The header text color has been adjusted for better visibility by modifying the NavigationMenuTrigger and NavigationMenuLink components.
</text>
```
    ...
    <Link href={href}>
      <NavigationMenuLink
        className={cn(
          navigationMenuTriggerStyle(),
          isActive && "bg-accent/50 text-accent-foreground",
          "cursor-pointer text-foreground dark:text-white font-medium"
        )}
      >
        {children}
      </NavigationMenuLink>
