...
const FrameVisualizer: React.FC<FrameVisualizerProps> = ({
    ...
    return (
      <div className="preview-placeholder">
        <div className="flex flex-col items-center justify-center py-10">
          ...
          <p className="text-light-textSecondary dark:text-dark-textSecondary">Select a {missingItem} to see preview</p>
        </div>
      </div>
    );
  }
  ...
  const frameEdgeSize = Math.max(30, Number(frame.width) * 10); // Scale the frame edge size based on the frame width
