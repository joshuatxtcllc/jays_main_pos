...
// Helper function to get frames by manufacturer
export const getFramesByManufacturer = (manufacturer: string): Frame[] => {
  if (manufacturer === 'all') {
    return frameCatalog;
  }
...
export const getFramesByMaterial = (material: string): Frame[] => {
  if (material === 'all') {
    return frameCatalog;
  }
...
// Helper function to get frames by width range
...
// Helper function to get frames by price range
