...
export async function getAllInventoryLocations(req: Request, res: Response) {
  try {
    ...
    return res.status(500).json({ message: 'Error fetching inventory locations' });
  }
}
...
export async function getInventoryLocationById(req: Request, res: Response) {
  try {
    ...
    return res.status(500).json({ message: 'Error fetching inventory location' });
  }
}
...
export async function createInventoryLocation(req: Request, res: Response) {
  try {
    ...
    return res.status(500).json({ message: 'Error creating inventory location' });
  }
}
...
export async function updateInventoryLocation(req: Request, res: Response) {
  try {
    ...
    return res.status(500).json({ message: 'Error updating inventory location' });
  }
}
...
export async function deleteInventoryLocation(req: Request, res: Response) {
  try {
    ...
    return res.status(500).json({ message: 'Error deleting inventory location' });
  }
}
